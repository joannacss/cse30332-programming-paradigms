...
// creating an object and initializing it with values
let user3 = {name: "Mark", age: 50};
...
let kiko = Animal('Kiko', 5)
let snow = Animal('Snow', 30)
...
let kiko = Animal2('Kiko', 5)
let snow = Animal2('Snow', 30)
console.log(kiko);
console.log(snow);
